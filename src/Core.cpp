...
void RayTracer::Core::run(void)
{
    ...
    std::shared_ptr<RayTracer::Sphere> sphere = std::make_shared<RayTracer::Sphere>(Maths::Vertex(0, 0, 15), 10, flashMaterial);
    ...
    std::shared_ptr<RayTracer::Sphere> sphere4 = std::make_shared<RayTracer::Sphere>(Maths::Vertex(0, 0.6, -0.75), 0.25, flashMaterial2);
    sphere2->setRotation(Maths::Vertex(0, 0, 0));
