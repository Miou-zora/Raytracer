...
void RayTracer::BasicCore::setScenePath(std::string scenePath)
{
...
void RayTracer::BasicCore::buildScene(void)
{
    libconfig::Config cfg;
...
void RayTracer::BasicCore::initCamera(libconfig::Setting &cameraSetting)
{
    try {
...
void RayTracer::BasicCore::setTransformation(libconfig::Setting &setting, RayTracer::Camera &camera)
{
    try {
...
void RayTracer::BasicCore::initPrimitives(libconfig::Setting &setting)
{
    try {
...
void RayTracer::BasicCore::initLights(libconfig::Setting &setting)
{
    try {
...
std::shared_ptr<RayTracer::Scene> RayTracer::BasicCore::getScene(void) const
{
    return (nullptr);
}
